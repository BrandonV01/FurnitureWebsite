...
def create_product():
    if request.method == "POST":
        ...
        if is_admin():
            return render_template("create_product.html", title="Create Product - Furniture Store")
        else:
            return redirect(url_for("admin_pages.admin"))
...
def edit_product(product_id):
    if is_admin():
        ...
        if request.method == "POST":
            ...
            return render_template("edit_product.html", product = product, title="Edit Product - Furniture Store")
...
def create_subtag():
    if request.method == "POST":
        ...
        if found_subtag:
            ...
            subtag = subtag_list(form_name, form_description, file_name)
        ...
        if is_admin():
            return render_template("create_subtag.html", title="Create Sub-Category - Furniture Store")
        else:
            return redirect(url_for("admin_pages.admin"))
...
def edit_subtag(subtag_id):
    if is_admin():
        ...
        if request.method == "POST":
            ...
            return render_template("edit_subtag.html", subtag = subtag, title="Edit Sub-Category - Furniture Store")
